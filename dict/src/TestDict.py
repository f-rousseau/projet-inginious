...
import dic as student


class MyDict(unittest.TestCase):

    def test_find_0(self):
        rep = "\nFONCTION FIND\nVotre fonction a trouvé une personne {} lorsqu'elle a été appellée avec {} alors que {} n'existait pas " \
    ...
    def test_find_1(self):
        rep = "\nFONCTION FIND\nVotre fonction a retourné {} lorsqu'elle a été appellée avec {} alors que la bonne réponse était {}. " \
    ...
    def test_add_0(self):
        rep = rep = "\nFONCTION ADD\nVotre dictionnaire de clients était {} lorsque votre fonction est appelée avec {} comme argument " \
